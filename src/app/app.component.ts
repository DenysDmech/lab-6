...
export class AppComponent implements OnInit {
  ...
  loadPost() {
    ...
    this.http.get<Todo[]>('https://jsonplaceholder.typicode.com/todos?_limit=5')
      ...
      .subscribe(response => {
        ...
        this.posts = response.sort((a, b) => a.title.localeCompare(b.title));
        this.flagLoad = false;
      });
  }
  ...
  completedPost(id: number | undefined) {
    if (!id) {
      return;
    }
    this.http.put(`https://jsonplaceholder.typicode.com/todos/${id}`,{completed:true})
      .subscribe((res: any) => {
